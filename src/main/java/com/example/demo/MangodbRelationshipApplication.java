...
public class MangodbRelationshipApplication implements CommandLineRunner {
    private PersonRepository personRepository;

    public MangodbRelationshipApplication(PersonRepository personRepository) {
        this.personRepository = personRepository;
    }

    public static void main(String[] args) {
        SpringApplication.run(MangodbRelationshipApplication.class, args);
    }
